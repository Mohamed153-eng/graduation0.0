...
class _OnboardingScreenState extends State<OnboardingScreen> {
  final List<PageViewModel> pages = [
    PageViewModel(
      ...
      body: "The program is supervised by the most skilled pharmacists to answer your inquiries",
      image: const Center(
        child: Text(
          "👋",
    ...
    PageViewModel(
      ...
      body: "Specialized in all kinds of international medicines, working 24 hours at your service",
      image: Center(
        child: Image.asset(
